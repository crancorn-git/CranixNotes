...
process.env.VITE_PUBLIC = require$$1$4.app.isPackaged ? process.env.DIST : path.join(__dirname$1, "../public");
let win;
function createWindow() {
  win = new require$$1$4.BrowserWindow({
    ...
    minHeight: 600,
    frame: false,
    // <--- This removes the white system bar completely
    titleBarStyle: "hidden",
    // <--- This keeps the "Snap Layout" functionality
    titleBarOverlay: {
      color: "#00000000",
      // Transparent background
      symbolColor: "#9CA3AF",
      // Gray color for the ( _ □ X ) buttons
      height: 30
